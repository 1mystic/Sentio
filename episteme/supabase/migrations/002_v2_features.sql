-- Episteme V2 Feature Migrations
...
-- Add metacognitive_note to learner_profiles if it doesn't exist
ALTER TABLE learner_profiles ADD COLUMN IF NOT EXISTS metacognitive_note TEXT;
